...
[database]
connection = {{ tuple . "ironic_inspector" "ironic_inspector" (default .Values.postgres.users.ironic_inspector.password .Values.inspector_db_password) | include "db_url" }}
